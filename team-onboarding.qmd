...
We rely heavily on [GitHub](https://github.com/) for collaboration, and there are a few things you must do to get set up. First, complete the NCEAS GitHub Tutorial [here](https://lter.github.io/workshop-github/rstudio.html). This tutorial will help you with getting started with `git` and GitHub using RStudio.
