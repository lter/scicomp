...
Again, if all of your group's content lives in one place, it straightforward to modify access to that repository. Note however that granting or removing access then becomes 'all or nothing' which may be a drawback in some contexts.
